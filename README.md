...
| <a name="input_location"></a> [location](#input\_location) | value for the location of the resources | `string` | `"switzerlandnorth"` | no |
| <a name="input_project-name"></a> [project-name](#input\_project-name) | used as the main part of the name of the resources | `string` | n/a | yes |
